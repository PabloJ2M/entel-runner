...
namespace Environment
{
    public class Parallax : MonoBehaviour
    {
        ...
        private const string OffsetId = "_TextureOffset";
        ...
        {
            GameManager.Instance.onSpeedUpdated.AddListener(AddSpeedConstant);
        }

        private void OnDisable()
        {
            GameManager.Instance.onSpeedUpdated.RemoveListener(AddSpeedConstant);
        }

        private void AddSpeedConstant(float amount)
        {
            AddSpeed(amount * Time.deltaTime);
        }
        ...
        public void AddSpeed(float amount)
        {
            ...
            Vector2 currentOffset = (Vector2)_material.GetVector(OffsetId) + movement;
            _material.SetVector(OffsetId, currentOffset);
